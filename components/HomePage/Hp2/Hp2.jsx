...
import styles from './Hp2.styles'; // Import your React Native styles
...
const Hp2 = (props) => {
  ...
  return (
    <View style={styles.hpSection2}>
      <Text style={styles.sectionTitle}>New Testament Stories ___</Text>
      <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.cardContainer}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Category', { category: 'NTS' })}>
